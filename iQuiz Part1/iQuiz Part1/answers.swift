...
class answers: UIViewController {
    ...
    var givenArray : [Dictionary<String, String>] = []
    ...
    override func viewDidLoad() {
        ...
        answerQuestion.text! = givenArray[givenCount]["Question"]!
        answerAnswer.text! = "The correct answer is \(givenArray[givenCount]["Correct Answer"]!)"
        if (givenAnswer == givenArray[givenCount]["Correct Answer"]) {
